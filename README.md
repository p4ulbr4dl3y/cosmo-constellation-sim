...
- автономная архитектура и дублированное ядро: синхронная реализация физики и маршрутизации на Python и TypeScript с верификацией через `parity.test.ts`; веб-интерфейс работает автономно без бэкенда на статических зеркалах и мгновенно пересчитывает граф связности.
