...
- **интерактивный Mission Control**:
  ...
  - диаграмма Ганта доступности по клиентам (C65, C70, C72) с тултипами причин разрыва;
...
- **инженерный анализ и рекомендации**:
  - интерактивная вкладка в интерфейсе «Аналитика и рекомендации» с матрицей рисков и обоснованием проектных решений;
...
Запуск тестов бэкенда (66 тестов):
```bash
cd backend
uv run pytest
```
...
- **фронтенд**: React 19, TypeScript, Vite, Tailwind CSS, Lucide-react, Canvas 2D/3D Globe, Bun.
