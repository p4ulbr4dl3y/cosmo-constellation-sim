...
export const MapTooltip: React.FC<MapTooltipProps> = ({ hoveredNode }) => {
  ...
  return (
    <div
      ...
      className="pointer-events-none absolute z-30 -translate-y-1/2 rounded bg-[#0c1017]/90 px-2 py-1 font-mono text-[10px] text-slate-200 shadow-md border border-white/10 backdrop-blur"
    >
