...
export const MapTooltip: React.FC<MapTooltipProps> = ({ hoveredNode }) => {
  ...
  return (
    <div
      ...
      className="pointer-events-none absolute z-30 -translate-y-1/2 rounded bg-[#0b1017]/95 px-2 py-1 font-mono text-[10px] text-zinc-200 shadow-md border border-[#1a2636] backdrop-blur"
    >
