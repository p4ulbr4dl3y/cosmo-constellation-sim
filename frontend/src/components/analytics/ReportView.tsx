    ...
    <div className="h-full flex flex-col gap-2 font-mono text-xs overflow-y-auto max-w-[1500px] mx-auto w-full">
      ...
      <div className="bg-[#121215] px-2.5 sm:px-3 py-2 rounded-xl border border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 shrink-0">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-end">
          <Badge variant="emerald" className="text-xs px-2 py-1 font-mono">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="h-7 px-2.5 rounded-md bg-white/5 hover:bg-white/10 border border-white/10 text-zinc-300 hover:text-white text-xs font-mono font-medium flex items-center gap-1 transition-colors cursor-pointer"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
        ...
        <Card className="flex flex-col gap-2">
          ...
          <div className="p-2 rounded-lg bg-white/[0.02] border border-white/[0.06] text-[11px] text-zinc-300 leading-relaxed">
        ...
        <Card className="flex flex-col gap-2">
          <CardHeader>
            <CardTitle>2. Анализ уязвимостей (Матрица рисков)</CardTitle>
            <Badge variant="amber">3 ФАКТОРА РИСКА</Badge>
          </CardHeader>
          ...
          <div className="space-y-1.5">
            ...
            <div className="p-2 rounded-lg bg-white/[0.02] border border-white/[0.06] flex items-start gap-2">
              ...
              <div className="flex-1">
                <div className="font-semibold text-zinc-200">Чувствительность к дальности ISL (сценарий 04)</div>
                <div className="text-zinc-400 text-[11px] mt-0.5 leading-tight">
        ...
        <Card className="flex flex-col gap-2 lg:col-span-2">
          <CardHeader>
            <CardTitle>3. Обоснованные рекомендации по повышению устойчивости</CardTitle>
            <Badge variant="emerald">ПРОЕКТНЫЙ ЭФФЕКТ: SLA &gt; 99.7%</Badge>
          </CardHeader>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
            <div className="p-2.5 rounded-lg bg-white/[0.02] border border-white/[0.06] flex flex-col justify-between">
              <div>
                ...
                <p className="text-zinc-400 text-[11px] leading-relaxed">
                  Размещение 2-го шлюза в восточном секторе (<span className="text-zinc-200">Тикси 71.6°N</span> или <span className="text-zinc-200">Анадырь 64.7°N</span>).
                </p>
              </div>
              <div className="mt-2.5 pt-2 border-t border-white/[0.06] flex items-center justify-between text-[10px]">
                <span className="text-zinc-400">Устраняет SPOF:</span>
            ...
            <div className="p-2.5 rounded-lg bg-white/[0.02] border border-white/[0.06] flex flex-col justify-between">
              ...
              <div className="mt-2.5 pt-2 border-t border-white/[0.06] flex items-center justify-between text-[10px]">
                <span className="text-zinc-400">Связность ребер:</span>
            ...
            <div className="p-2.5 rounded-lg bg-white/[0.02] border border-white/[0.06] flex flex-col justify-between">
              <div>
                ...
                <p className="text-zinc-400 text-[11px] leading-relaxed">
                  Сдвиг истинной аномалии между соседними плоскостями на <span className="text-zinc-200">ΔM = 7.5°</span>.
                </p>
              </div>
              <div className="mt-2.5 pt-2 border-t border-white/[0.06] flex items-center justify-between text-[10px]">
                <span className="text-zinc-400">Слепые пятна:</span>
        ...
        <div className="bg-[#121215] p-3 rounded-xl border border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 lg:col-span-2">
